    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          onChange={handleChange}
          className="w-full px-4 py-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl focus:border-primary-500 focus:outline-none transition-all duration-300'use client'
import { motion } from 'framer-motion'
import { Mail, Github, Linkedin, MapPin, Send, MessageCircle, Phone } from 'lucide-react'
import { personalInfo } from '@/lib/data'
import { useState } from 'react'
